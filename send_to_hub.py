...
connection_string = "HostName=diazure-hub.azure-devices.net;DeviceId=Raspi;SharedAccessKey=2XqEDVnSzL1+K0DjxlZ55qABBO8n69K9+I6oqG9dbI4="
cpu = psutil.cpu_percent(interval=1)
ram = psutil.virtual_memory()
disk = psutil.disk_usage("/")

msg_txt = "{\"ram\": "+str(ram.available)+",\"disk\": "+str(disk.percent)+",\"cpu\": "+str(cpu)+"}"
#msg_txt = "{\"cpu\": cpu, \"ram\": ram.available,\"disk\": disk.percent}"
